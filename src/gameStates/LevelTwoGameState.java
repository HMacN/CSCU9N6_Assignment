...
public class LevelTwoGameState implements IGameState, KeyListener
{
    ...
    public LevelTwoGameState(SpaceshipGame spaceshipGame)
    {
        ...
        this.tileMap.loadMap("maps", "SpaceShipTwo.txt");
